        ...
        if (intent != null) {
            ...
            if (VPN_SERVICE_ACTION.equals(intent.getAction()) || !DISCONNECT_ACTION.equals(intent.getAction())) {
                ...
                if (bundle != null) {
                    ...
                    profile.setUserCertificateAlias(bundle.getString("Alias"));
                    ...
                    Log.e(TAG, bundle.getString("Alias"));
                    Log.e(TAG, bundle.getString("Cert"));

                    X509Certificate cert = TrustedCertificateManager.generateX509Certificate(bundle.getString("Cert"));
                    Log.e(TAG, cert.toString());

                    try {
                        TrustedCertificateManager.getInstance().fetchCertificate(profile.getUserCertificateAlias(), cert);
                    } catch (KeyStoreException e) {
                        e.printStackTrace();
                    }
                    TrustedCertificateManager.getInstance().loadCertificates();
...
//        builder.setContentIntent(pending);
    ...
    private byte[][] getTrustedCertificates() {
        ...
        try {
            ...
            if (alias != null) {
                ...
                Log.e(TAG, "сертификат по элиасу " + cert.toString());
            ...
            Log.e(TAG, "сертификаты загружены " + alias);
    ...
    private PrivateKey getUserKey() throws KeyChainException, InterruptedException {
        Log.e(TAG, "keeeeeeeeeeeeeeeeeeeeey" + KeyChain.getPrivateKey(getApplicationContext(), mCurrentUserCertificateAlias).toString());
